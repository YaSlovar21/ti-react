        ...
        <h2 className="section-title section-title_ti">О компании</h2>
            <ul className="mainpage-about__grid">
                ...
                <li className="mainpage-about__grid-item">
                    ...
                    <p className="bem__paragraph mainpage-about__paragraph">Разработанная нами программа предназначена для расчета и подбора пластинчатого теплообменника. Для расчета нужно внести все необходимые данные по температурам, давлению и мощности.</p>
